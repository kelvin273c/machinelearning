...
```{r cache=FALSE, message=F, warning=F}
#Random Forest
#set.seed(124)
...
The accuracy rate, `CMgbm3$overall[[1]]`, suggests a very good fit overall. This would not be expected from an independent set of results taken from different individuals than those involved in the original experiment. The so-called out of sample error rate (1-accuracy level) is expected to be greater than `1-CMgbm3$overall[[1]]`, the in-sample-error rate.
